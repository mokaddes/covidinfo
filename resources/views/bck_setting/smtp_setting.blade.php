                                ...
                                <div class="tab-content">
                                    <div id="conf" class="container tab-pane active"><br>
                                        <div class="row justify-content-center">
                                            <div class="col-lg-8">
                                                <form class="admin-form" action="{{ route('smtp.setting.update', $smtp->id) }}" method="POST">
                                                    @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <table class="table table-bordered table-striped dataTable no-footer" id="admin-table" width="100%" cellspacing="0" role="grid" aria-describedby="admin-table_info" style="width: 100%;">
                                                                    <thead>
                                                                        <tr role="row">
                                                                            <th width="20%" class="sorting_disabled" rowspan="1" colspan="1" style="width: 355px;">@lang('web.type')</th>
                                                                            <th width="20%" class="sorting_disabled" rowspan="1" colspan="1" style="width: 354px;">@lang('web.subject')</th>
                                                                            <th width="15%" class="sorting_disabled" rowspan="1" colspan="1" style="width: 261px;">@lang('web.action')</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        ...
                                                                        <tr role="row" class="even">
                                                                            ...
                                                                            <td>
                                                                                <div class="action-list text-center">
                                                                                    <a class="btn btn-secondary btn-sm" href="{{ route('email.edit', $row->id) }}">
