...
<body id="kt_body" class="bg-body">
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        <div class="mb-1">
            <img style="width:180px;" alt="Logo" src="{{ asset('back/logo.png') }}" />
        </div>
        <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_sign_up_form" method="POST" action="{{ route('register') }}">
                @csrf
                ...
                <div class="row fv-row mb-7 fv-plugins-icon-container">
                    <div class="col-12">
                        ...
                        <input class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name') }}" autocomplete="off">
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <input class="form-control  form-control-lg form-control-solid @error('email') is-invalid @enderror" type="email" id="email" name="email" value="{{ old('email') }}" autocomplete="off">
                    <div class="fv-plugins-message-container invalid-feedback"></div>
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
