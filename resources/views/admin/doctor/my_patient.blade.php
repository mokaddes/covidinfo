    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title"><b>@lang('web.patient_report_list')</b><span class="badge badge-info">{{count($patients)}}</span></h3>
                            ...
                            <td class="text-center">
                                <div class="action-list">
                                    <a class="btn btn-primary btn-sm" title="view"
                                        href="{{ route('admin.patient.report.view', $patient->id) }}">
