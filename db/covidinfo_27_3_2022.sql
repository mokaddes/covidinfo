...
CREATE TABLE `covideffect_doctor_mapping` (
  `id` int(10) NOT NULL,
...
(24, 35, 68, 38, '2022-03-27 09:13:22', 1, NULL, NULL, '2022-03-27 09:13:22', 1, NULL, NULL, 1);
...
(1, 'registration', 'Welcome To PATV', 'Welcoem to our system', NULL, NULL, 1, 'Email'),
...
(10, 'Registration_sms	', 'Welcome To PATV', 'test sms', NULL, NULL, 1, 'SMS'),
(11, 'Doctor_assigned_to_doctor_sms', 'Doctor assigned', ' has been appointed to you', NULL, NULL, 1, 'SMS'),
(12, 'Doctor_assigned_to_patient_sms', 'Doctor assigned', 'Doctor assigned to the customer sms', NULL, NULL, 1, 'SMS'),
(13, 'Change_status_sms', 'Change report status', 'Your Report has been changed sms', NULL, NULL, 1, 'SMS');
...
CREATE TABLE `report_remarks` (
  `id` int(10) NOT NULL,
  `user_id` int(11) DEFAULT NULL COMMENT 'patient id',
  ...
  `report_by` int(1) NOT NULL COMMENT '	0 = superadmin, 1=admin,2=doctor,3=patient	',
  `covideffect_id` int(11) DEFAULT NULL
...
--
-- Indexes for table `covideffect_doctor_mapping`
--
ALTER TABLE `covideffect_doctor_mapping`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `report_remarks`
--
...
--
-- AUTO_INCREMENT for table `covideffect_doctor_mapping`
--
ALTER TABLE `covideffect_doctor_mapping`
...
--
-- AUTO_INCREMENT for table `report_remarks`
--
ALTER TABLE `report_remarks`
